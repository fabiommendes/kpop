...
def get_parser():
    ...
    """
    parser = argparse.ArgumentParser('pystructure')
...
def main(args=None):
    """
    Called with ``python -m pystructure.tests``: run main test suite.
    """
    ...
    import kpop.tests as test_module
