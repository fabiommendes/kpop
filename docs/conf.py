...
# implements a search _results scorer. If empty, the default will be used.
...
# If true, admix page references after internal links.
#latex_show_pagerefs = False

# If true, admix URL addresses after external links.
